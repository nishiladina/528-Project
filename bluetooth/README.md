...
In VS Code, press `Ctrl K, Ctrl O` and open the `IMU_ESP_IDF_STREAM` folder. Opening this folder (as opposed to cd'ing into it) will activate the ESP-IDF extension. 
